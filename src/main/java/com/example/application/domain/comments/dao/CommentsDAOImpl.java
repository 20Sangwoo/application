package com.example.application.domain.comments.dao;
...
public class CommentsDAOImpl implements CommentsDAO {
  ...
  public Long save(Comments comment) {
    ...
    sql.append("VALUES (bbs_comment_id_seq.nextval, :postId, :writer, :content, systimestamp, systimestamp) ");
  ...
  @Override
  public List<Comments> findByPostIdByPage(Long postId, int offset, int size) {
    String sql = "SELECT * FROM comments WHERE post_id = :postId ORDER BY comment_id DESC OFFSET :offset ROWS FETCH NEXT :size ROWS ONLY";
